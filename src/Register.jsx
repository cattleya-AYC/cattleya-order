...
const RECEIPT_ADDR = "data:image/png;base64,";
...
export default function Register() {
  ...
  const fetchOrders = async () => {
    ...
    else setDebugMsg("取得件数: " + (data ? data.length : 0) + "件　更新: " + new Date().toLocaleTimeString("ja-JP", { hour: "2-digit", minute: "2-digit", second: "2-digit" }));
    setOrders(data || []);
  };
