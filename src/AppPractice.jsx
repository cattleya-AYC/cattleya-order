...
export default function App() {
  ...
  if (screen === "table") return (
    <div style={{ padding: 16, background: "#0f0a05", minHeight: "100vh", color: "#f0e6d0" }}>
      ...
      {/* 練習モードバナー */}
      <div style={{ background: "#2a2a00", border: "2px solid #ffcc00", borderRadius: 10, padding: "10px 16px", marginBottom: 12, textAlign: "center" }}>
        <div style={{ color: "#ffcc00", fontSize: 18, fontWeight: 900 }}>🟡 練習モード</div>
        <div style={{ color: "#aa9900", fontSize: 12, marginTop: 2 }}>データは一切送信されません。安心して練習してください！</div>
      </div>
  ...
  if (sent) return (
    <div style={{ padding: 24, background: "#0f0a05", minHeight: "100vh", color: "#f0e6d0", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
      ...
      <div style={{ color: "#c9952a", fontFamily: "serif", fontSize: 28, fontWeight: 900, marginBottom: 6 }}>キッチンに送りました（練習）</div>
      <div style={{ background: "#2a2a00", border: "2px solid #ffcc00", borderRadius: 8, padding: "8px 16px", marginBottom: 16 }}>
        <div style={{ color: "#ffcc00", fontSize: 14, fontWeight: 700, textAlign: "center" }}>🟡 練習モード：実際には送信されていません</div>
      </div>
